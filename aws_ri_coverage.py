...
services = [
            ...
            aws_service('es','domain',{},['ElasticsearchClusterConfig.InstanceCount','ElasticsearchClusterConfig.DedicatedMasterCount'], ['ElasticsearchClusterConfig.InstanceType','ElasticsearchClusterConfig.DedicatedMasterType'],{},'ElasticsearchInstanceCount','ElasticsearchInstanceType',[])
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p","--printheader",action='store_true',help="output header") # string
