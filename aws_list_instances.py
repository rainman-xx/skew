...
if __name__ == '__main__':
    ...
    parser=argparse.ArgumentParser(description='List AWS ec2,rds,elaticache,es, and redshift instances')
    ...
    if args.printheader:
        print('region,resource,id,name,product,instance_type,dim_1,dim_2')
